...
import loginButton from "@/assets/img/swamp/svg/login_button.svg";
import signUpButton from "@/assets/img/swamp/svg/sign_up_button.svg";
        ...
        <header className={styles.header}>
            <div className={styles.headerLeft}>
                <div className={styles.logoContainer}>
                    ...
                    {user?.id != null && (<div className={styles.discoverContainer}>
                            {path !== "/notes/search" && (
